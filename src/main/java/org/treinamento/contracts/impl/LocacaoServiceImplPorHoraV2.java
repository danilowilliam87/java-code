...
public class LocacaoServiceImplPorHoraV2 implements LocacaoServiceV2 {

    private double pagamentoBasico;
    private double imposto;

    public LocacaoServiceImplPorHoraV2() {
    ...
    public double calcularPagamentoBasico(LocalDateTime retirada, LocalDateTime retorno, double valor) {
        this.pagamentoBasico =  valor * this.calcularHorasDoAluguel(retirada, retorno);
    ...
    private long calcularHorasDoAluguel(LocalDateTime retirada, LocalDateTime retorno){
        ...
        return DataUtils.calcular(retirada, retorno, DataUtils.CALCULAR_ALUGUEL_POR_HORAS);
    }
